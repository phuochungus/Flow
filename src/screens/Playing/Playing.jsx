        ...
        <ScrollView style={styles.container}>
            <View style={{opacity: isUpLyrics !== false ? 0 : 1}}>
                ...
                <View style={styles.DVDContainer}>
                    <ImageBackground style={[styles.imgBackground, {transform: [{rotate: '0deg'}],}]} source={{uri: player2?.songInfo.images ? player2?.songInfo.images[0]?.url : "https://png.pngtree.com/png-clipart/20190918/ourmid/pngtree-load-the-3273350-png-image_1733730.jpg"}}>
